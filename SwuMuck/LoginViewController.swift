...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    override func didReceiveMemoryWarning() {
        ...
        @IBAction func loginPressed() {
            ...
            let urlString: String = "http://condi.swu.ac.kr/student/W01iphone/loginUser.php"
            ...
            let restString: String = "&id=" + loginUserid.text! + "&password=" + loginPassword.text!
                ...
                //"&id=" + loginUserid.text! + "&password= \(loginPassword.text!)";
            
            
            //\(loginUserid.text!) "&pwd= \(loginPassword.text!)"
                //+ loginUserid.text! + "&password=" + loginPassword.text!
